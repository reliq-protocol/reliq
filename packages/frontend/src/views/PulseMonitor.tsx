...
import { Fingerprint, Info, ArrowRight, Signal, Wifi, BatteryFull, ScanFace, CheckCircle2, ShieldAlert, Wallet, LogOut, X, Copy, ChevronRight, User, HelpCircle, Activity, Hexagon, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-background-dark text-white pb-24">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-between px-6 pb-8 pt-4 max-w-md mx-auto w-full h-full">
        ...
        <header className="w-full flex items-center justify-between relative py-4">
           {/* Logo and Brand */}
           <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-surface to-background-dark border border-white/10 flex items-center justify-center shadow-lg group">
                <Hexagon className="text-primary group-hover:rotate-90 transition-transform duration-500" size={20} strokeWidth={2} />
              </div>
